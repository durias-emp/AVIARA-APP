    ...
    plugins: [
      ...
      VitePWA({
        ...
        workbox: {
          ...
          globIgnores: [
            '**/assets/{fixes,land,airport_details,runway_geometry,world_ref,airports,airport_search,airways,navaids,cenamer_airspace,preferred_routes,procedures,procedures_index,aux_aerodromes}-*.js',
          ],
          ...
          runtimeCaching: [
            {
              ...
              urlPattern: /\/assets\/(fixes|land|airport_details|runway_geometry|world_ref|airports|airport_search|airways|navaids|cenamer_airspace|preferred_routes|procedures|procedures_index|aux_aerodromes)-[^/]+\.js$/,
              handler: 'CacheFirst',
              options: {
