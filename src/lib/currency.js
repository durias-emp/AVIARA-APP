...
// ---------------------------------------------------------------------------
export const FAR = {
  imsafe:         { ref: '91.3',    label: 'FAR 91.3',     url: 'https://www.ecfr.gov/current/title-14/chapter-I/subchapter-F/part-91/subpart-A/section-91.3' },
  flightReview:   { ref: '61.56',   label: 'FAR 61.56',    url: 'https://www.ecfr.gov/current/title-14/chapter-I/subchapter-D/part-61/subpart-A/section-61.56' },
  passenger90:    { ref: '61.57(a)',label: 'FAR 61.57(a)', url: 'https://www.ecfr.gov/current/title-14/chapter-I/subchapter-D/part-61/subpart-A/section-61.57' },
  night90:        { ref: '61.57(b)',label: 'FAR 61.57(b)', url: 'https://www.ecfr.gov/current/title-14/chapter-I/subchapter-D/part-61/subpart-A/section-61.57' },
  ifrCurrency:    { ref: '61.57(c)',label: 'FAR 61.57(c)', url: 'https://www.ecfr.gov/current/title-14/chapter-I/subchapter-D/part-61/subpart-A/section-61.57' },
  ipc:            { ref: '61.57(d)',label: 'FAR 61.57(d)', url: 'https://www.ecfr.gov/current/title-14/chapter-I/subchapter-D/part-61/subpart-A/section-61.57' },
  medical:        { ref: '61.23',   label: 'FAR 61.23',    url: 'https://www.ecfr.gov/current/title-14/chapter-I/subchapter-D/part-61/subpart-A/section-61.23' },
  medicalDur:     { ref: '61.23(d)',label: 'FAR 61.23(d)', url: 'https://www.ecfr.gov/current/title-14/chapter-I/subchapter-D/part-61/subpart-A/section-61.23' },
  crewDocs:       { ref: '61.3',    label: 'FAR 61.3',     url: 'https://www.ecfr.gov/current/title-14/chapter-I/subchapter-D/part-61/subpart-A/section-61.3' },
  airworthCert:   { ref: '91.203',  label: 'FAR 91.203',   url: 'https://www.ecfr.gov/current/title-14/chapter-I/subchapter-F/part-91/subpart-C/section-91.203' },
  registration:   { ref: '91.203',  label: 'FAR 91.203',   url: 'https://www.ecfr.gov/current/title-14/chapter-I/subchapter-F/part-91/subpart-C/section-91.203' },
  opLimitations:  { ref: '91.9',    label: 'FAR 91.9',     url: 'https://www.ecfr.gov/current/title-14/chapter-I/subchapter-F/part-91/subpart-A/section-91.9' },
  weightBalance:  { ref: '91.103',  label: 'FAR 91.103',   url: 'https://www.ecfr.gov/current/title-14/chapter-I/subchapter-F/part-91/subpart-A/section-91.103' },
  annual:         { ref: '91.409',  label: 'FAR 91.409',   url: 'https://www.ecfr.gov/current/title-14/chapter-I/subchapter-F/part-91/subpart-E/section-91.409' },
  hundredHour:    { ref: '91.409',  label: 'FAR 91.409',   url: 'https://www.ecfr.gov/current/title-14/chapter-I/subchapter-F/part-91/subpart-E/section-91.409' },
  pitotStatic:    { ref: '91.411',  label: 'FAR 91.411',   url: 'https://www.ecfr.gov/current/title-14/chapter-I/subchapter-F/part-91/subpart-E/section-91.411' },
  transponder:    { ref: '91.413',  label: 'FAR 91.413',   url: 'https://www.ecfr.gov/current/title-14/chapter-I/subchapter-F/part-91/subpart-E/section-91.413' },
  elt:            { ref: '91.207',  label: 'FAR 91.207',   url: 'https://www.ecfr.gov/current/title-14/chapter-I/subchapter-F/part-91/subpart-C/section-91.207' },
  ads:            { ref: '91.417',  label: 'FAR 91.417',   url: 'https://www.ecfr.gov/current/title-14/chapter-I/subchapter-F/part-91/subpart-E/section-91.417' },
  requiredEquip:  { ref: '91.205',  label: 'FAR 91.205',   url: 'https://www.ecfr.gov/current/title-14/chapter-I/subchapter-F/part-91/subpart-C/section-91.205' },
  vorCheck:       { ref: '91.171',  label: 'FAR 91.171',   url: 'https://www.ecfr.gov/current/title-14/chapter-I/subchapter-F/part-91/subpart-B/section-91.171' },
}
