  ...
  return (
    ...
    <div ref={shellRef} style={{
      ...
      <div ref={sheetRef} className="drawer-surface" style={{
        ...
        // The blur is set with the opacity rather than fixed here, because the
        // two are one decision: transparency is what shows the map through, and
        // blur is the only thing keeping what sits on top of it readable.
        backdropFilter: 'blur(var(--drawer-blur, 32px)) saturate(1.5)',
