...
/* ── Aircraft library ────────────────────────────────────── */
// Imported as well as re-exported: a bare re-export creates no local binding,
// and this file uses TEMPLATES itself. Onboarding imports it from here.
          ...
          {isHelicopter ? (
            ...
            <div style={{ fontSize: 11, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 8 }}>
              ...
              {/* Sets the descent rate the altitude advisor plans with, which is
                  ...
                  It sits here, among the specification figures, because it is a
                  fact about the aeroplane rather than a figure off a chart:
                  when the sea-level performance card went, this had nowhere
                  chart-shaped to follow it to. A choice rather than a field. */}
